-- ============================================================================
-- 2D CS-LIKE MULTIPLAYER FFA v8 • V5 BASE + LIGHT PREDICTION
--
...
local WORLD_W = 3600
local WORLD_H = 2400
local PROTOCOL_VERSION = "CSFFA8"
local ROOT_CHANNEL = "cs2d_ffa_multiplayer_v8"
...
-- ОКНО
-- ---------------------------------------------------------------------------
local win = create_window("2D CS • MULTIPLAYER FFA v8 • V5 BASE", START_W, START_H)
...
print("CS2D MULTIPLAYER FFA v8 V5-BASE PREDICTION started")
